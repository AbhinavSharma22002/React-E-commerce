    ...
    return (
        ...
        <footer id="footer">
            ...
            <div className="rightfooter">
                ...
                <a href="#"><img src="./insta.svg" alt="" height="50px" width="50px"></img>Instagram</a>
                {/* eslint-disable-next-line*/}
                <a href="#"><img src="./face.svg" alt="" height="50px" width="50px"></img>Facebook</a>
                {/* eslint-disable-next-line*/}
                <a href="#"><img src="./you.svg" alt="" height="60px" width="60px"></img>Youtube </a>
            </div>
        </footer>
